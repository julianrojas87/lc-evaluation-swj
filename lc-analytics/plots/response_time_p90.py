...
fig.suptitle('Query response time vs LC data fragment size', fontsize=18)
lw = 2

ax1.plot(nl_waterbus_x, nl_waterbus_y, marker='o', markersize=3.5, label="Netherlands-Waterbus", linewidth=lw)
ax1.annotate(str(int(nl_waterbus_min[0])) + "," + str(int(nl_waterbus_min[1])), 
...
ax1.annotate(str(int(sydney_trainlink_min[0])) + "," + str(int(sydney_trainlink_min[1])), 
...
ax1.annotate(str(int(thailand_greenbus_min[0])) + "," + str(int(thailand_greenbus_min[1])), 
...
ax2.annotate(str(int(kobe_subway_min[0])) + "," + str(int(kobe_subway_min[1])), 
...
ax2.annotate(str(int(deutsche_bahn_min[0])) + "," + str(int(deutsche_bahn_min[1])), 
...
ax2.annotate(str(int(renfe_min[0])) + "," + str(int(renfe_min[1])), 
...
ax2.annotate(str(int(auckland_waiheke_min[0])) + "," + str(int(auckland_waiheke_min[1])), 
...
ax2.annotate(str(int(nairobi_sacco_min[0])) + "," + str(int(nairobi_sacco_min[1])), 
...
ax2.annotate(str(int(san_francisco_bart_min[0])) + "," + str(int(san_francisco_bart_min[1])), 
...
ax3.annotate(str(int(amsterdam_gvb_min[0])) + "," + str(int(amsterdam_gvb_min[1])), 
...
ax3.annotate(str(int(nmbs_min[0])) + "," + str(int(nmbs_min[1])), 
...
ax3.annotate(str(int(sncf_min[0])) + "," + str(int(sncf_min[1])), 
...
ax3.annotate(str(int(stib_min[0])) + "," + str(int(stib_min[1])), 
...
ax3.annotate(str(int(london_tube_min[0])) + "," + str(int(london_tube_min[1])), 
...
ax3.annotate(str(int(flixbus_min[0])) + "," + str(int(flixbus_min[1])), 
...
ax4.annotate(str(int(new_york_mtabc_min[0])) + "," + str(int(new_york_mtabc_min[1])), 
...
ax4.annotate(str(int(madrid_bus_min[0])) + "," + str(int(madrid_bus_min[1])), 
...
ax4.annotate(str(int(tec_min[0])) + "," + str(int(tec_min[1])), 
...
ax4.annotate(str(int(delijn_min[0])) + "," + str(int(delijn_min[1])), 
...
ax4.annotate(str(int(helsinki_hsl_min[0])) + "," + str(int(helsinki_hsl_min[1])), 
...
ax4.annotate(str(int(nz_bus_min[0])) + "," + str(int(nz_bus_min[1])), 
...
ax4.annotate(str(int(chicago_cta_min[0])) + "," + str(int(chicago_cta_min[1])), 
