...
Our evaluation was performed on a set of 22 different and real public transport networks from around the world. The raw data of these networks is originally formatted as GTFS data dumps, [which we make available](https://cloud.ilabt.imec.be/index.php/s/7PeH9L3MijrHCRi).
...
We provide already the [set of busiest day Linked Connections for every network](https://cloud.ilabt.imec.be/index.php/s/brWo8jgwgHYcE6k).
