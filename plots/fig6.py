...
ax1.annotate(str("{:.3f}".format(nl_waterbus_min[1])), 
...
ax1.annotate(str("{:.3f}".format(sydney_trainlink_min[1])), 
...
ax1.annotate(str("{:.3f}".format(thailand_greenbus_min[1])), 
...
ax2.annotate(str("{:.3f}".format(deutsche_bahn_min[1])), 
...
ax2.annotate(str("{:.3f}".format(renfe_min[1])), 
...
ax2.annotate(str("{:.3f}".format(auckland_waiheke_min[1])), 
...
ax2.annotate(str("{:.3f}".format(nairobi_sacco_min[1])), 
...
ax2.annotate(str("{:.3f}".format(san_francisco_bart_min[1])), 
...
ax3.annotate(str("{:.3f}".format(nmbs_min[1])), 
...
ax3.annotate(str("{:.3f}".format(sncf_min[1])), 
...
ax3.annotate(str("{:.3f}".format(stib_min[1])), 
...
ax3.annotate(str("{:.3f}".format(london_tube_min[1])), 
...
ax3.annotate(str("{:.3f}".format(flixbus_min[1])), 
...
ax3.annotate(str("{:.3f}".format(nz_bus_min[1])), 
...
ax3.annotate(str("{:.3f}".format(new_york_mtabc_min[1])), 
...
ax3.set_yscale("log")
ax3.set_xscale("log")
ax3.set_yticks([700, 1500, 3000, 5000, 10000, 20000, 30000])
...
ax4.annotate(str("{:.3f}".format(tec_min[1])), 
...
ax4.annotate(str("{:.3f}".format(delijn_min[1])), 
...
ax4.annotate(str("{:.3f}".format(helsinki_hsl_min[1])), 
...
ax4.annotate(str("{:.3f}".format(chicago_cta_min[1])), 
...
ax4.set_yscale("log")
ax4.set_xscale("log")
ax4.set_yticks([7000, 10000, 20000, 30000, 50000, 70000])
